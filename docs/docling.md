...
accesible solo desde la red interna de Compose. Así, PyTorch y los modelos de
...
aplicaciones ajenas al bundle. Por eso el paquete no crea ni distribuye otra
API key. Si una instalación decide exponer Docling, queda fuera de este
contrato seguro y debe añadir autenticación en su despliegue.
